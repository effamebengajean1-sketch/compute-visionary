...
export const Route = createFileRoute("/atelier")({
  head: () => ({
    meta: [
      { title: "Atelier d'automates finis — CompilLab" },
      {
        name: "description",
        content:
          "Créez, visualisez et transformez des automates finis : déterminisation, minimisation, reconnaissance de mots et plus.",
      },
      { property: "og:title", content: "Atelier d'automates finis — CompilLab" },
      {
